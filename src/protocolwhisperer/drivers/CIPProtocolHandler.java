...
public class CIPProtocolHandler implements ProtocolHandler{
    ...
    public CIPProtocolHandler(DriverMenuHandler aDmh, MainFrame aParentFrame, BridgeEntryContainer aParentEntryContainer, JPanel aIncomingDataSettings, JPanel aOutgoingPanel)
    {
