 ...
 */
public class StaticTagProtocolRecord extends ProtocolRecord{
    public Class getProtocolHandlerClass()
    {
        return StaticTagHandler.class;
    }
    public StaticTagProtocolRecord()
    {
    }
    public StaticTagProtocolRecord(int aType, String calledMenuItem)
    {
